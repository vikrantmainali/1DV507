...
public class SortingAlgorithms 
{
	...
	{
		int[] a = {32, -23, 12, -19, 4 , 8, -5, 99, 0, 41, -4, -88, -101};
		System.out.println("Testing using insertion sort (int[]): " + Arrays.toString(insertionSort(a)));	
		System.out.println("Testing using merge sort (int[]): " + Arrays.toString(mergeSort(a)));	
		
		String[] b = {"zebra", "apple", "zimbabwe", "microsoft", "samsung"};
        Comparator<String> test =  (s1, s2) -> s2.compareTo(s1);		
		System.out.println("\nTesting using insertion sort (String[]): " + Arrays.toString(insertionSort(b,test)));	
		System.out.println("Testing using merge sort (String[]): " + Arrays.toString(mergeSort(b,test)));
	}
